...
You will probably note that switching to the public timeline doesn't work. And that when the app tries to reload the timeline as it sits there twittering the UI gets all kinds of fucked up. Working on that, yeknow.
